...
if ($_SESSION['UserType']=='P')
{
	...
	if ($idate > $date)
	{	
		$empty_q= "DELETE * FROM question$class_code";
		mysql_query($empty_q, $con) or die("can't empty question table: ".mysql_error());
		$empty_v= "DELETE * FROM vocab$class_code";
