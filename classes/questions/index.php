...
<div class="container-fluid" id="container">
	...
	<div  id= "right-col" class="span4">
			...
			<form action="" method="POST">
				...
				<td align="right"><button type="submit" name="submit" id="submit_login" class="btn btn-primary pull-right">Sign in</button></td></tr>
				<tr><td><a href="forgot_password.php">Forgot Password?</a></td></tr>
				</table>
				
				<!--<table>
				<tr><td><input type="checkbox" name="setcookie" id="setcookie" value="setcookie"> &nbsp;Stay logged in</td>
				<td><button type="submit" name="submit" id="submit_login" class="btn pull-right">Sign in</button></td></tr>
				<tr colspan="2"><td><a href="forgot_password.php">Forgot Password?</a></td></tr>
				</table>-->
