...
if (!isset($_SESSION['Email']) || $_SESSION['UserType'] != "T") 
{
...
<title>SubmitQ - Enroll in a Class</title>
	...
	<script type="text/javascript">	
		...
		$('#add_class_t').ajaxStop(function(){
			$(this).removeClass('loading disabled');
		})
		$('#add_class_t').click(function(){
...
<p>You may register as a TA for a course if the professor has given you a class code. If you do not have a class code, please contact the professor or <a href="refer.php">refer</a> him or her to SubmitQ.</p>
...
<form method="POST">
	<table>
		...
		<tr><td></td><td><button type="submit" name="update" id="add_class_t" class="btn btn-primary pull-right">Register as a TA</button></td></tr>
	</table>
</form>
