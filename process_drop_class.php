...
if($_POST)
{
	...
	$class=mysql_result(mysql_query("SELECT class FROM all_classes WHERE last_name='$last_name' AND class_number='$class_num'"), 0);
	...
	echo "You have successfully dropped <b>$class_num</b>.";
	echo "<br /><br /><a href= 'profile.php'>Return to profile</a>";
}
?>