...
echo"</br>";
			...
			if($count==0)
			{echo "</br>You are currently not enrolled in any classes. <a href='add_class_t.php'>Add classes</a>!!</br></br>";}
			?>
			</div>
			<div class="row-fluid">
				<div>
					<h3>Account Management</h3>
					<a href='add_class_t.php'>Add Class</a>
				   ...
				   if ($class_code != NULL)
					...
					//get the list of all files inside class folder 
						...
						for($k= 2; $k<= $list_num +1; $k++)
						{
							...
							{
								//echo "<br>";
								echo "<a href='classes/$class_code/$list[$k]' target='_blank'>20$date &nbsp Questions</a>";
								echo "</br>";	
							}
							else
							{
								//echo "<br>";
								echo "<a href='classes/$class_code/$list[$k]' target='_blank'>20$date &nbsp Vocab</a>";
								echo "</br>";	
							}
						}
							echo "</br>";
